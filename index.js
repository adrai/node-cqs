...
index.eventDenormalizerBase = require('cqrs-eventdenormalizer').eventDenormalizerBase;
index.eventExtenderBase = require('cqrs-eventdenormalizer').eventExtenderBase;